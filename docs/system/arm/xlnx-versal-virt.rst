...
Xilinx Versal SoC is a familiy of heterogenous and multi-core
systems on chip that combine traditional hardend CPUs and I/O
peripherals in a Processing System (PS) with runtime programmable
FPGA logic (PL) and an AI Engine.

https://www.xilinx.com/products/silicon-devices/acap/versal.html

The familiy of Versal SoCs share a single architecture but come in
...
for bootloaders or firmware to pick it up.
...
Boot PetaLinux 2019.2 via ARM Trusted Firmware, U-boot:
.. code-block:: bash
